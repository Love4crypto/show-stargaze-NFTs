...
export const TOKENS = gql`
  query Tokens($collectionAddr: String, $limit: Int) {
    tokens(collectionAddr: "stars1w7842fz4ccl6fapqu6nydn59tzaq33kakd2n5ctltrl697t5fqkqr8q5ap", limit: $limit) {
      tokens {
        tokenId
        imageUrl
      }
...
export const COLLECTION = gql`
  query Collection($collectionAddr: String!) {
    collection(collectionAddr: "stars1w7842fz4ccl6fapqu6nydn59tzaq33kakd2n5ctltrl697t5fqkqr8q5ap") {
      image
    }
  }
`;
